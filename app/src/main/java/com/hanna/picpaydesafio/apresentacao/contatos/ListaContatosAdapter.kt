...
class ListaContatosAdapter(
        ...
        val cliqueItemLista: ((contato: Contato) -> Unit)
    ...
    override fun onCreateViewHolder(pai: ViewGroup, viewTipo: Int): ListaContatosViewHolder {
        ...
        return ListaContatosViewHolder(view, cliqueItemLista)
    }
    ...
    class ListaContatosViewHolder(itemView: View, val cliqueItemLista: ((contato: Contato) -> Unit)) : RecyclerView.ViewHolder(itemView) {
        ...
        fun incorporaDados(contato: Contato) {
            ...
            itemView.setOnClickListener {
                cliqueItemLista.invoke(contato)
            }
        }
    }
}